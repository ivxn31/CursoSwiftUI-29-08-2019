...
//mercedes Color(red: 79.0/255.0, green: 164.0/255.0, blue: 161.0/255.0)
//ferrari Color(red: 231.0/255.0, green: 50.0/255.0, blue: 40.0/255.0)
//redbull Color(red: 34.0/255.0, green: 44.0/255.0, blue: 54.0/255.0)
//renault Color(red: 240.0/255.0, green: 238.0/255.0, blue: 95.0/255.0)
//mclaren Color(red: 240.0/255.0, green: 172.0/255.0, blue: 61.0/255.0)
let mercedes = Team(color: .mercedes, imageName: .mercedes)
let ferrari = Team(color: .ferrari , imageName: .ferrari)
let redbull = Team(color: .redbull, imageName: .renault)
let renault = Team(color: .mclaren, imageName: .redbull)
let mclaren = Team(color: .renault, imageName: .mclaren)
